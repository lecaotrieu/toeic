...
CREATE TABLE examminationquestion (
...
ALTER TABLE examminationquestion ADD CONSTRAINT fk_examinationquestion_examination FOREIGN KEY (examinationid) REFERENCES examination(examinationid);
