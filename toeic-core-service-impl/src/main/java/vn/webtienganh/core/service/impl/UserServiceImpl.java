...
import vn.webtienganh.core.service.UserService;
import vn.webtienganh.core.service.utils.SingletonDaoUtil;
import vn.webtienganh.core.utils.UserBeanUtil;
...
public class UserServiceImpl implements UserService {
    ...
    public UserDTO findByName(String name) {
            UserEntity userEntity = SingletonDaoUtil.getUserDaoInstance().findEqualUnique("name",name);
