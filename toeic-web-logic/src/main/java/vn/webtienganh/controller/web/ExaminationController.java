...
import vn.webtienganh.command.ExaminationCommand;
import vn.webtienganh.command.ExerciseCommand;
...
public class ExaminationController extends HttpServlet {
    ...
    private void executeSearchExamination(HttpServletRequest request, ExaminationCommand command) {
        ...
        Object[] objects = SingletonServiceUtil.getExaminationServiceImpl().findExaminationByProperties(properties, command.getSortExpression(), command.getSortDirection(), command.getFirstItem(), command.getMaxPageItems());
