...
@WebServlet(urlPatterns = {"/danh-sach-bai-tap"})
public class ExerciseController extends HttpServlet {
    ...
    private void executeSearchExercise(HttpServletRequest request, ExerciseCommand command) {
        ...
        Object[] objects = SingletonServiceUtil.getExerciseServiceImpl().findExerciseByProperties(properties, command.getSortExpression(), command.getSortDirection(), command.getFirstItem(), command.getMaxPageItems());
