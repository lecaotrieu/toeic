...
<c:url value="/admin-guideline-listen-list" var="requestUrl"/>
...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    <%--<a href="${listenGuidelineEditUrl}" type="button">Thêm bài hd</a>--%>
                                ...
                                <div class="table-btn-controls">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <c:url var="addUrl" value="/admin-guideline-listen-edit">
                                                <c:param name="urlType" value="url_edit"/>
                                            </c:url>
                                            ...
                                            <button class="dt-button buttons-html5 btn btn-white btn-primary btn-bold" type="button" id="deleteAll" disabled onclick="warningBeforeDelete()"
                            ...
                            <fmt:bundle basename="ApplicationResources">
                                <display:table id="tableList" name="items.listResult" partialList="true"
                                    ...
                                    <display:column title="<fieldset class='form-group'>
                                                    ...
                                                    class="center select-cell chonCheckBox"
                                                    headerClass="center select-cell chonCheckBox">
                                        <fieldset>
                                    ...
                                    <display:column titleKey="label.action" class="">
                                        <c:url value="/admin-guideline-listen-edit" var="editUrl">
                                            <c:param name="urlType" value="url_edit"/>
                                        ...
                                        <a class="btn btn-sm btn-primary btn-edit" href="${editUrl}"
                                           data-toggle="tooltip"
                                           title="<fmt:message key='label.guideline.listen.edit' bundle='${lang}'/>">
