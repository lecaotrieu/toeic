...
<c:url value="/admin-user-import" var="importUrl">
...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    <%--                    <a href="${listenGuidelineEditUrl}" type="button">Thêm Role hd</a>--%>
                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            ...
                                            <button type="button"
                                                    ...
                                                    id="deleteAll" disabled data-toggle="tooltip"
                            ...
                            <fmt:bundle basename="ApplicationResources">
                                <display:table id="tableList" name="items.listResult" partialList="true"
                                    ...
                                    <display:column titleKey="label.action" class="">
                                        <c:url value="/ajax-admin-user-edit" var="editUrl">
                                            <c:param name="urlType" value="url_edit"/>
