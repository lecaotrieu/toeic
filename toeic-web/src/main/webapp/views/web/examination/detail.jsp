...
<c:set value="<%=WebConstant.EXAMINATION_TYPE_PHOTO%>" var="PHOTO"/>
<c:set value="<%=WebConstant.EXAMINATION_TYPE_QUESTION_RESPONSE%>" var="QUESTION_RESPONSE"/>
<c:set value="<%=WebConstant.EXAMINATION_TYPE_SINGLE_PASSAGE%>" var="SINGLE_PASSAGE"/>
