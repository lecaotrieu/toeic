...
<c:url var="urlList" value="/danh-sach-huong-dan-nghe"/>
<html>
<head>
    <title></title>
</head>
                ...
                <c:forEach var="item" items="${items.listResult}">
                    <div class="image group">
                        ...
                        <div class="grid news_desc">
                            <h3>${item.title}</h3>
                            <c:url var="detailUrl" value="/noi-dung-bai-huong-dan-nghe">
                                <c:param name="pojo.listenguidelineid" value="${item.listenguidelineid}"/>
                            </c:url>
